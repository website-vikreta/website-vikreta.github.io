...
const Calculator = () => {
                        ...
                        <>
                         {/* <p>🇮🇳 <span
                              ...
                              <svg xmlns="http://www.w3.org/2000/svg" width="12" height="13" viewBox="0 0 12 13" fill="none">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M1.23517 3.98456C1.27 3.94964 1.31139 3.92193 1.35695 3.90303C1.4025 3.88412 1.45134 3.87439 1.50067 3.87439C1.55 3.87439 1.59884 3.88412 1.6444 3.90303C1.68995 3.92193 1.73134 3.94964 1.76617 3.98456L6.00067 8.21981L10.2352 3.98456C10.27 3.94969 10.3114 3.92204 10.357 3.90317C10.4025 3.8843 10.4514 3.87459 10.5007 3.87459C10.55 3.87459 10.5988 3.8843 10.6444 3.90317C10.6899 3.92204 10.7313 3.94969 10.7662 3.98456C10.801 4.01943 10.8287 4.06082 10.8476 4.10637C10.8664 4.15193 10.8761 4.20075 10.8761 4.25006C10.8761 4.29937 10.8664 4.34819 10.8476 4.39375C10.8287 4.4393 10.801 4.48069 10.7662 4.51556L6.26617 9.01556C6.23134 9.05048 6.18995 9.07819 6.14439 9.09709C6.09884 9.116 6.05 9.12573 6.00067 9.12573C5.95134 9.12573 5.9025 9.116 5.85695 9.09709C5.81139 9.07819 5.77 9.05048 5.73517 9.01556L1.23517 4.51556C1.20025 4.48073 1.17254 4.43934 1.15364 4.39379C1.13473 4.34823 1.125 4.29939 1.125 4.25006C1.125 4.20073 1.13473 4.15189 1.15364 4.10633C1.17254 4.06078 1.20025 4.01939 1.23517 3.98456Z" fill="white"/>
                              </svg>                             */}
  ...
  return (
    ...
    >
        ...
        {/* <div className="container"> */}
          <div className="content1">
            <div className="title-wrapper">
              ...
              {!isSubmitted &&(<div className="button-group1">
                <a href="/#cal" className="normal-btnp primary">
                  Get Started Now
                </a>
              </div>)}
            </div>
      ...
      {
      !isSubmitted && (<div className="cal" id={"cal"}>
            ...
            <div className="summary">
              ...
              {isClicked && (
                <form className="order-form" onSubmit={sendEmail}>
                  ...
                  <button className="normal-btnp primary">
                    Place Order
                    <svg
                      width="17"
                      height="17"
